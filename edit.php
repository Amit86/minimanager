...
if(1 ==  $err)
    ...
    $output .= '
            <h1>
                <font class="error\">'.$lang_edit['use_valid_email'].'</font>
            </h1>';
else if(3 == $err)
    $output .= '
            <h1>
                <font class="error\">'.$lang_edit['data_updated'].'</font>
            </h1>';
else if(4 == $err)
    $output .= '
            <h1>
                <font class="error\">'.$lang_edit['error_updating'].'</font>
            </h1>';
else if(5 == $err)
    $output .= '
            <h1>
                <font class="error\">'.$lang_edit['del_error'].'</font>
            </h1>';
else
    $output .= '
