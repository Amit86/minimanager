...
elseif (2 == $err)
    $output .= '
            <h1>
                <font class="error">'.$lang_repair['repair_finished'].' : '.$num.' '.$lang_repair['tables'].'</font>
            </h1>';
elseif (3 == $err)
    $output .= '
            <h1>
                <font class="error">'.$lang_repair['no_table_selected'].'</font>
            </h1>';
elseif (4 == $err)
    $output .= '
            <h1>
                <font class="error">'.$lang_repair['repair_error'].' : '.$rep_err.'</font>
            </h1>';
else
    $output .= '
